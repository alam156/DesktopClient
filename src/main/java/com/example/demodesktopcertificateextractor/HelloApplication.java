...
public class HelloApplication extends Application {
    ...
    private static final String JSON_XML_SIGN_URL = "http://localhost:/8089/api/sign-xml";
    @Override
    public void start(Stage primaryStage) {
        ...
        Label label = new Label("Type Password");
        ...
        submitButton.setOnAction(event -> {
            ...
            if (!password.isEmpty()) {
                ...
                task.setOnSucceeded(workerStateEvent -> {
                    ...
                    for(int i=0; i<fetchedList.getCertificateList().size(); i++) {
                        responseListView.getItems().add(fetchedList.getCertificateList().get(i));
                    }
        ...
        vbox.getChildren().addAll(label,passwordField, submitButton, selectFileButton, responseListView);
